## Mouette.js project installation guide

You just cloned Mouette.js : git clone https://github.com/LCluber/Mouette.js.git
...
### Workflow
  ...
  - You can use those commands to build specific parts :
    ...
    - Start Express server manually :
      - Windows : Run **set DEBUG=Mouettejs:* & npm start**
